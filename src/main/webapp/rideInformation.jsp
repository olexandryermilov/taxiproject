...
<div class="w3-card-4">
    <div class="w3-container ">
        ...
        <label class="w3-text">Car number is ${carNumber}, ETA - ${arrivalTime} minute<c:if test="${arrivalTime mod 10 !=1}">s</c:if></label>
        <c:choose>
            <c:when test="${empty approved}">
               <form action="controller" method="post">
                ...
                <form action="controller" method="post">
                    <input type="hidden" name="command" value="refuseRide">
